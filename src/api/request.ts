...
class Request {
  ...
  post<T>(url: string, data?: any, config?: AxiosRequestConfig): Promise<ApiResult<T>> {
    return this.instance.post(url, data, config)
  }

  put<T>(url: string, data?: any, config?: AxiosRequestConfig): Promise<ApiResult<T>> {
    return this.instance.put(url, data, config)
  }

  delete<T>(url: string, data?: any, _object = {}): Promise<ApiResult<T>> {
    return this.instance.delete(url, { data, ..._object })
  }
}
